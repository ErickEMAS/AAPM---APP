...
class AddAgentePage extends StatefulWidget {
  const AddAgentePage({Key? key}) : super(key: key);

  @override
  State<AddAgentePage> createState() => _AddAgentePageState();
}

class _AddAgentePageState extends State<AddAgentePage> {
  final AddAgenteStore _store = serviceLocator<AddAgenteStore>();
      ...
      return Column(
        children: [
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(
              hintText: "Digite o nome completo do novo agente",
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(
              hintText: "Digite o email do novo agente",
              labelText: "Email",
            ),
          ),
          Expanded(
